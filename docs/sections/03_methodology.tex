...
\end{itemize}
Metodologi benchmarking menggunakan modul \texttt{timeit} untuk pengukuran latensi enkripsi/dekripsi (rata-rata dari 1000 iterasi) dan modul \texttt{tracemalloc} untuk mengukur puncak penggunaan memori RAM\footnote{Catatan: Pengukuran memori ini merepresentasikan \textit{Memory Footprint} dalam lingkungan \textit{runtime} Python dan mungkin berbeda secara signifikan dengan ukuran kode/RAM pada implementasi C/C++ \textit{bare-metal}.}.
