...
\begin{itemize}
    \item \texttt{src/bicycle\_lock\_terminal.py}\footnote{Kode sumber lengkap (simulasi dan kriptografi) tersedia di: https://github.com/SandWithCheese/makalah-kripto\label{fn:repo}}: Antarmuka terminal utama yang menangani registrasi sepeda dan simulasi proses \texttt{lock/unlock}.
