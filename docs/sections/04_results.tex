...
\end{itemize}
Hasil ini konsisten dengan desain ASCON yang memang ditujukan untuk perangkat terkekang (\textit{constrained devices}) dengan RAM sangat terbatas. AES-GCM membutuhkan tabel \textit{lookup} yang lebih besar dan state management yang lebih kompleks.
